...
export default function App() {
  ...
  // grade.py drops its output at viewer/public/result.json -- if it's there,
    ...
    <div className="mx-auto max-w-5xl px-6 py-8">
      ...
      {!result && !error && checkedAutoLoad && (
        ...
        >
          ...
          <span>
            Click "Load result.json" above to pick a file produced by <code>python -m scoring</code>.
          </span>
        </div>
      )}
