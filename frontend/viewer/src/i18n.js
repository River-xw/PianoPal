...
const dict = {
  ...
  navLearnModeDesc: { zh: "灯光引导 + 宽松评分，轻松上手一首新歌", en: "LED-guided practice with lenient scoring -- good for learning a new song" },
  navPerformMode: { zh: "演奏模式", en: "Performance Mode" },
  navPerformModeDesc: { zh: "无灯光引导 + 严格评分，检验真实演奏实力", en: "No LED guidance, strict scoring -- check whether you've really got it" },
  navMe: { zh: "我的", en: "Me" },
  navMeDesc: { zh: "练习足迹、能力画像与成长曲线", en: "Practice history, profile, trends and comparisons" },
  ...
  practiceQuote4: { zh: "错音非败笔，是指引下遍圆满的线索。", en: "A wrong note is not failure—it is a clue for the next try." },
  practiceQuote5: { zh: "拆解复杂的乐句，进步便会在不经意间悄然显现。", en: "Break down the hard measures and progress becomes easier to see." },
  ...
  trendChartTitle: { zh: "得分趋势", en: "Score trend" },
  compareTitle: { zh: "多项比对", en: "Comparison" },
  compareSelectHint: { zh: "勾选两条及以上的记录，即可对比子分数", en: "Select 2 or more records to compare their sub-scores" },
};
