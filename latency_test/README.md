...
python3 -m latency_test.calibrate --list-devices
```
...
```bash
python3 -m latency_test.calibrate --clicks 10 --interval 1.0 \
...
```bash
python3 -m latency_test.calibrate --input-device 3 --output-device 2 \
